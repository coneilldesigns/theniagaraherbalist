...
module.exports = {
	...
	// Project options.
	projectURL: 'local.theniagaraherbalist.com', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	productURL: './', // Theme/Plugin URL. Leave it like it is, since our gulpfile.js lives in the root folder.
	browserAutoOpen: false,
	injectChanges: true,

	// Style options.
	styleSRC: './assets/scss/landing-page.scss', // Path to main .scss file.
  ...
  // CSS Vendor options.
  cssVendorSRC: './vendor/**/*.css', // Path to JS vendor folder.
  cssVendorDestination: './assets/css/vendor/', // Path to place the compiled JS vendors file.
  cssVendorFile: 'vendor', // Compiled JS vendors file name. Default set to vendors i.e. vendors.js.
	...
	watchJsVendor: './vendor/**/*.js', // Path to all vendor JS files.
